...
export const PermitScalarFieldEnumSchema = z.enum(['id','full_name','user_id','department_id','type','approved','justification','valid_from','valid_until','deleted','createdAt','updatedAt']);
...
export const PermitOrderByRelevanceFieldEnumSchema = z.enum(['full_name','type','justification']);
